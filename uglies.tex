...
\begin{tikzpicture}[overlay,remember picture]
    ...
    ForestGreen]
    {
    {\fontsize{40}{42} \selectfont Academia}
    };
    
    % Title
    \node[align=center] at ($(current page.center)+(0,-5)$) 
    {
    {\fontsize{24}{24} \selectfont {{Uglies in Academia}}} \\[0.15in]
    %{\fontsize{18}{18} \selectfont {{Recognize them, Accept them, and Not Give a Damn About Them}}} \\[1in]    
...
Common examples include serving the faculty senate, scholarship committee, etc. The university often sends out emails asking for volunteers (this is somewhat generic and you can safely ignore), and sometimes people such as your dept chair or dean can directly ask you to serve (in which case you will want to consider it).
...
\chapter{Personal Homepage and Computer Setup}
\section{University-owned Computer}


\section{Personal Homepage}
It goes without saying that as CS faculty, especially tenure-track one, you should have a personal homepage.
It is a place where you can put your information, e.g., your CV, publications, teaching materials, etc. It is a CS academic culture that CS faculty (and even PhD students) has a personal homepage. That's how people Google you and find out about you. Your website is your online presence! Of course nowadays, you can also use social media such as Twitter/X, LinkedIn, etc, but a personal homepage is still the best way to present yourself and your work.



\subsection{University and Departmental Website}  Traditionally and also still commonly, faculty uses their departmental or university provided's webspace to host their lab and personal website, e.g., \url{https://cs.gmu.edu/~user}. This makes sense because (i) it is easy to setup (e.g., just \texttt{ssh} and \texttt{sftp} your files there), (ii) it is quite flexible, e.g., you can run various services such as blog, wiki, etc, and (iii) it is free and you don't have to pay for hosting (or backup). Moreover, there's a sense of pride and loyalty to your university (or workspace) and department.


\paragraph{Why you should NOT use departmental or university webspace?}  Nowadays many faculty use external hosting such as Github instad of their departmental or university webspace.  The main reasons being that: (i) they have always used it, e.g., during their grad school; (ii) it is flexibile, e.g., GitHub Pages allows easy static hosting and gives the benefit of revision; and (iii) it is more portable, e.g., you can move your website to a different hosting service without much hassle.


However, a less common but very important reason---when it happens, it can be a big deal---is that your departmental or university webspace is \emph{not} yours. You might think that it's your personal website and you won't likely do anything that violates the university's policy, and so nothing to worry about (exactly my thinking for years!). But the reality is that what you put on your \url{cs.univ.edu/~user} can be used against your university, department, or even yourself.  And while your department or university might not care about what you put on your website, they are very scared of lawsuits and negative publicity.

Ok, what's the big deal you said?  I don't put anything controversial on my website, so I am safe, right? Here are something you might not think about.

\paragraph{Compliance} Do you put education materials on your personal website?  a link to course syllabus?  presentations? lecture notes? Guess what, these might not be ADA\footnote{ The Americans with Disabilities Act (ADA) requires that all public websites are accessible to people with disabilities.  This means that your website should be accessible to people who are blind, deaf, or have other disabilities.  If your website is not ADA compliant, then it can be sued by the US Department of Justice or by individuals (e.g., students or their parents).  This is a big deal and can cost your university a lot of money.  So you should make sure that your website is ADA compliant.} compliant (e.g., are you sure the colors or fonts or space on those materials are accessible to people with disabilities?).
For example, I have students who asked me to use different fonts and colors due to their disabilities, and I happily obliged.  However, I can totally imagine some disgruntled student or parent suing the university because they failed the course due to inaccessible materials.


Another related one is student's privacy. Do you run \texttt{turnin} or plagiarism/AI detection stuff on your personal website?  If so then you're essentially storing and processing students' data on your personal website.

\begin{commentbox}
  At GMU, we are required to put our course materials on the university's Canvas system. Of course we do not know whether the materials are ADA compliant or not, but at least the university has a team of people (and likely automated tools) to check and make sure that the materials are ADA compliant.\\


  A teaching colleague said that they do not like these university's services like Canvas or Sharepoint (for file storage) because they suck, but at least they give some peace of mind that the university is responsible for making sure that the materials are compliant with the law, and if people sue, they will sue the university, not that faculty.  Sounds pretty reasonable to me!
\end{commentbox}

\paragraph{Political} Do you have a link to your personal blog or social media like Facebook that show what your endorse or like? Do you reference Twitter/X posts? these are be interpreted as you, as a faculty member of your department or university because it was posted from a \url{cs.university.edu} subdomain, endorsing a political party or candidate.  For example, the DOJ in 2025 opens an investigation into universities for political discrimination in hiring, and they cite a tweet (back when Twitter was still around) of the president of the university praising a political candidate that is now considered discriminatory.

Universities are very sensitive to these things.  A legal issue, a lawsuit, or a bad publicity bring a lot of trouble to the university, and guess who will be quoted in the news?  You, the faculty member who put the content on your website.  In short, these things sounds absurd, and probably never should happen, but in the current political climate, it does happen, and universities are tightening their policies and practices to avoid these issues.
...
\section{My Setup}
Just a simple setup that works for me.


\begin{itemize}
  \item Webpage: My lab website is hosted on GitHub Pages with a custom domain \url{roars.dev}.  Github Pages is free, relatively flexible (you can host some dynamic content there, e.g., see \url{https://roars.dev/csconfs}), gives the benefits of revision control, and is commonly used by many CS faculty.  My domain name \texttt{roars.dev} is through \texttt{porkbun.com}. I really didn't have much preference on domain hosting, I just go with porkbun because it is cheap (\$12/year) and has a good reputation.
  \item Email: I use my GMU email---hosted on GMU (more precisely Office365)---mainly for professional communication (e.g., with students and university/departmental matters). I have my personal email \url{tvn@roars.dev} for most other communications.  For my personal email I do not use a dedicated, paid mail hosting but instead just use \texttt{iCloud+}, which I already have and supports custom domain email.
  \item VPN: I have a Linux box at home running Wireguard, a VN server, and automatically connects all my connections (e.g., laptop, phone, etc) to it. Really convenient for accessing my home network when I am away, e.g., when I travel or work from home. My Linux box also runs a DNS server (Adguard) to block ads and trackers.
  I also connect to GMU's VPN when I need to access my lab network or other resources that are only accessible from the GMU network (e.g., magainze subscriptions, etc).
\end{itemize}

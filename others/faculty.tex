...
\paragraph{Why you should NOT use departmental or university webspace?}  Many faculty nowadays choose not to use their departmental or university webspace for their personal homepages and instead use external hosting such as Github.  While there are various reasons for this, the main ones are: (i) it is more flexibile, e.g., GitHub Pages allows easy static hosting and gives the benefit of revision, and (ii) it is more portable, e.g., you can move your website to a different hosting service without much hassle.


However, a less common but very important reason---when it happens, it can be a big deal---is that your departmental or university webspace is \emph{not} yours.
